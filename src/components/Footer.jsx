    ...
    return(
        <div>
            ...
            <div className="credit">
                <p>Copyright &copy; 2022 - {new Date().getFullYear()} Archilyas.com <br/><span>Made by <a target="_blank" rel="noreferrer"  href="https://shukurdev.vercel.app">Shukur Huseynli</a></span></p>
            </div>
        </div>
    );
}